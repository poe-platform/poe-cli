...
- [x] Receiving message / response should be blocking. 
...
- [ ] @ to select files
- [x] use Tailwind for UI components
- [x] previous chat history should be working
- [ ] key-up should rotate through history messages, like old school irc client
- [x] The spacing in preview is missing. Add some spacing so it doesn't look to chunked together. 
