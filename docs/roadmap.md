...
- [x] split out into separate command, don't run automatically
- [x] the configure should not have a check for install at all, it should just execute
- [x] update the github workflows

## Issue resolution triggers

- [x] Change the triggers for issue resolver e.g. claude-code to agent:claude-code

## Generated labels

- [x] add npm task to generate labels
...
- [x] Add option to disable the service (similar to branding) disabled=true
- [x] disable roo code

## Github bot

- [x] Configure a Github bot with following features
...
- [x] It must support various label
    - agent:<service>
