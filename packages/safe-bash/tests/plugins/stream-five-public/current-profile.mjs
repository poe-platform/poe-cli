...
export function currentProfile(original) {
  ...
  replace('contract("default factory and actual default dispatch remain 60 without opt-in",', 'contract("current default factory and dispatch expose the exact 82-command catalog",');
